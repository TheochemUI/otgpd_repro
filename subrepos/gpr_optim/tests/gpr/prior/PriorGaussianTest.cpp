...
PriorGaussianTest::PriorGaussianTest()
{
...
TEST_F(PriorGaussianTest, lp)
{
    gpr::Field<double> x;
    double lp = 0.;
    double lp_ref = -1.83787785664716e+000;
...
TEST_F(PriorGaussianTest, lpg)
{
    gpr::Field<double> x;
    gpr::Field<double> lpg;
    double lpg_ref[2] = {-888.953211438594e-006, -888.953211438594e-006};
